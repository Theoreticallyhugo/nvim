...
end, desc("TODO-COMMENTS: Next todo-type comment"))
map("n", "<leader>tp", function()
  require("todo-comments").jump_prev()
end, desc("TODO-COMMENTS: Previous todo-type comment")
)
...
end, desc("TODO-COMMENTS: Next fixme comment"))

map("n", "<leader>tt", function()
  require("todo-comments").jump_next({ keywords = { "TODO" } })
end, desc("TODO-COMMENTS: Next todo comment"))

map("n", "<leader>tj", "<cmd> TodoTelescope <CR>", desc("TODO-COMMENTS: Next todo comment"))
